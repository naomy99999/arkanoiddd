...
// Called every frame
void ACapsuleObj::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);

}

void ACapsuleObj::Boil() {
	//Log the Boil procedure 
	GEngine->AddOnScreenDebugMessage(-1, 15.f, FColor::Yellow, FString::Printf(TEXT("Boil %s"), *GetCapsuleName())); 
